	...
	<div class="card-body">
		...
		<div class="row">
			<div class="col-sm-4">
				...
				<div class="row pb-2">
					<span class="col-4">Perusahaan</span>
					<span class="col-8">: <b>{{ $model->perusahaan }}</b></span>
				</div>
				<div class="row pb-2">
					<span class="col-4">Pemilik</span>
					<span class="col-8">: <b>{{ $model->pemilik }}</b></span>
				</div>
				<div class="row pb-2">
					<span class="col-4">CP</span>
					<span class="col-8">: <b>{{ $model->cp }}</b></span>
				</div>
				<div class="row pb-2">
			...
			<div class="col-sm-4">
				<div class="row pb-2">
					<span class="col-4">NPWP</span>
					<span class="col-8">: <b>{{ $model->npwp }}</b></span>
				</div>
				<div class="row pb-2">
					<span class="col-4">PKP</span>
					<span class="col-8">: <b>{{ $model->pkp ? 'ya' : 'tidak' }}</b></span>
				</div>
				<div class="row pb-2">
				...
				<div class="row pb-2">
					...
					<span class="col-8">
						@foreach($model->kontak_supplier()->get() as $k)
	...
	<div class="col-md-8">
		<div class="card shadow mb-4">
			<div class="card-header">
				<h6 class="m-0 font-weight-bold text-secondary">Barang Terbanyak Dibeli</h6>
			</div>
			<div class="card-body">
	...
	<div class="col-md-4">
		...
		<div class="card border-bottom-secondary shadow py-2 mb-4">
		  <div class="card-body">
		    <div class="row no-gutters align-items-center">
		      <div class="col mr-2">
		        <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">Jumlah Pembelian</div>
		        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $model->pembelian()->count() }} kali</div>
		      </div>
		      <div class="col-auto">
		...
		<div class="card border-bottom-primary shadow py-2 mb-4">
		  <div class="card-body">
		    <div class="row no-gutters align-items-center">
		      <div class="col mr-2">
		        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Jumlah Uang Keluar</div>
		        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ rupiah($model->pembelian()->sum('total'), true) }}</div>
		      </div>
		      <div class="col-auto">
		...
		<div class="card border-bottom-warning shadow py-2 mb-4">
		  <div class="card-body">
		    <div class="row no-gutters align-items-center">
		      <div class="col mr-2">
		        <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Jumlah Hutang Belum Lunas</div>
		        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ rupiah($model->pembelian()->where('status_lunas', '0')->sum('hutang'), true) }}</div>
		      </div>
		      <div class="col-auto">
